<nav class="navbar navbar-default">
                        <div class="container-fluid">
                            ...
                            <a class="navbar-brand" href="{{url('/')}}">Bienvenido {{Auth::User()->name}} !</a>
                            </div>

                            <!-- Collect the nav links, forms, and other content for toggling -->
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li><a href="{{url('personaje')}}"><img src="{{url('images/nav/personaje.png')}}" />Mi Personaje</a></li>
                                <li><a href="{{url('inventario')}}"><img src="{{url('images/nav/inventario.png')}}" /> Inventario</a></li>
